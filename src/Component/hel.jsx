    ...
    <div className="relative bg-white/20 backdrop-blur-md ml-0.5 shadow-lg w-[40%] h-[85vh] mt-22 max-w-md p-8 overflow-auto">
      ...
      <form className="space-4-5" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          {error.Mobile && (
            <p className="text-red-600 text-sm mt-1 min-h-[1.2rem]">{error.Mobile}</p>
          )}
        </div>
        ...
        <ReCAPTCHA
          ...
          sitekey="6LcTgJQrAAAAAIOYRws2OWmxS9XWKHqzBm8waqPj"
        ...
        <p className="mt-4 text-black text-center" style={{ fontFamily: "fantasy" }}>
